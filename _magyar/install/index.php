...
<div class="container">
	<div class="page-header">
		<h1 align="center">Telepítés</h1>
	</div>

	<div class="row">
		<div class="col-sm-1"></div>
		<div class="col-md-5">
		<h3>MySQL Database Belépés</h3><br>
		<form id = "sql-data">
			<div class="form-group">
			<label for="host">Hoszt</label>
			...
			<p id="passwordHelpBlock" class="form-text text-muted">
				Ha az adatbázis még nem létezik, akkor a program megcsinálja. 
			</p>
			</div>		
			
			<div class="text-center">
			<br>
			<button type="button" id="submitButton" class="btn btn-success disabled btn-lg" onclick="submitLogin();" disabled>Belépés</button>
